...
const socialLinks = [
  {
    label: "GitHub",
    href: "https://github.com/darjandev",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/in/darjandev",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="size-4">
        ...
        <div className="flex flex-col gap-8 py-12 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div className="flex flex-col gap-8 sm:flex-row sm:gap-16">
            ...
            <div className="space-y-3">
              <p className="text-xs font-semibold uppercase tracking-widest text-muted-foreground opacity-50">
                Navigation
              </p>
