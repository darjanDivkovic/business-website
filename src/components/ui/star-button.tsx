...
export function StarButton({
  ...
  return (
    ...
    >
      ...
      <span className="relative z-10 mt-4 inline-block bg-gradient-to-t from-black to-neutral-400 bg-clip-text text-transparent [filter:drop-shadow(0_1px_2px_rgba(0,0,0,0.85))_drop-shadow(0_0_6px_rgba(0,0,0,0.6))] dark:from-white dark:to-neutral-500 dark:[filter:drop-shadow(0_1px_2px_rgba(255,255,255,0.6))_drop-shadow(0_0_6px_rgba(255,255,255,0.35))]">
        {children}
      </span>
    </button>
  );
